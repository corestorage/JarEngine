...
import org.jarengine.device.impl.FontManagerImpl;
...
public class J2SEFontManager implements FontManagerImpl
{
	...
	org.jarengine.device.impl.Font getFont(Font meFont)
	{
    	int key = 0;
    	key |= meFont.getFace();
    	key |= meFont.getStyle();
    	...
    	org.jarengine.device.impl.Font result = (org.jarengine.device.impl.Font) fonts.get(new Integer(key));
	...
	public void setFont(String face, String style, String size, org.jarengine.device.impl.Font font) {
		int key = 0;
	...
	public org.jarengine.device.impl.Font createSystemFont(String defName, String defStyle, int defSize, boolean antialiasing) {
		return new J2SESystemFont(defName, defStyle, defSize, antialiasing);
	}

	public org.jarengine.device.impl.Font createTrueTypeFont(URL defUrl, String defStyle, int defSize, boolean antialiasing) {
